    ...
    if __name__ == '__main__':
            ...
            for i in range(a):
                ...
                p2 = multiprocessing.Process(
                    target=download_image('https://cdn.pixabay.com/photo/2016/03/31/19/25/america-1294996__340.png'))
            ...
            print(f"Multiprocessing ended in {round(end - start, 2)} second(s)")
            for i in range(a):
                start = time.perf_counter()
